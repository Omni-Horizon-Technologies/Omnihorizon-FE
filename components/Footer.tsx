    ...
    <footer className="bg-white border-t border-slate-200/60 mt-auto">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-lg bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-700 transition-colors"
        ...
        <motion.div
          ...
          className="mt-12 pt-8 border-t border-slate-200/60 text-center"
        >
          <p className="text-xs text-slate-600">
            © {new Date().getFullYear()} Omnihorizon. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
